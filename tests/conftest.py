...
@pytest.fixture
def list_of_dicts_fixture() -> list:
    return [
...
'Фикстуры и переменные для transaction_descriptions'

description_res = ['Перевод организации', 'Перевод со счета на счет',
...
'Фикстуры и переменные для card_number_generator'
...
"Переменные для test_external_api"
