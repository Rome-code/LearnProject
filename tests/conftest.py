...
exp_with_result_usd = ["Перевод организации", "Перевод со счета на счет", "Перевод с карты на карту"]

exp_with_result_rub = ["Перевод со счета на счет", "Перевод организации"]
...
rub_transaction = {
    ...
    "state": "EXECUTED",
    "date": "2019-08-26T10:50:58.294041",
    "operationAmount": {"amount": "1", "currency": {"name": "RUB", "code": "RUB"}},
    "description": "Перевод организации",
    "from": "Maestro 1596837868705199",
    "to": "Счет 64686473678894779589",
}
...
path_to_json_empty_file = os.path.join(
